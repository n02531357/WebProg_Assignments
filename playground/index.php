...
<div class="container">
    ...
    <div class="container">
        <div class="page-header">
            <h1>Welcome</h1>
            <p>This web application's purpose is to assist the user in tracking their nutritional and fitness goals.</p>
        </div>
    </div>
    ...
    <div class="container" style="padding-bottom: 25px;">
	    <div class="row">
	    	<div class="col-md-2"></div>
	  		...
	  		<div class="col-md-2" style="text-align: center; margin-top: 50px;"><h2><em>or</em></h2></div>
	  		<div class="col-md-3">
	  			<h3><em>Sign up!</em></h3>
	  				<form role="form">
					  	<div class="form-group">
